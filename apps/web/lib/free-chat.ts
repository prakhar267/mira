...
export function buildFreeChatSystemPrompt(input: EdgeCompanionRequest) {
  ...
  return [
    ...
    "A correction replaces the old fact. Keep first-person experiences with the user. Distinguish stated facts from your suggestions. When recalling a plan, include the requested facts and constraints. Preserve the user's point of view without claiming their plans or relatives as your own.",
